    ...
    if (fs.existsSync(app)) {
      ...
      if (!fs.existsSync(appDir)) {
        ...
        if (fs.existsSync(appDir)) {
          ...
          // This error is for handling slow IO operations as for whatever magical reason some versions of node fail to sync creating directories when using a slow storage device!
          } else {
        ...
        // Directory does not exist after attempting to create it
        } else {
          process.stdout.write('[x]');
          console.log('');
